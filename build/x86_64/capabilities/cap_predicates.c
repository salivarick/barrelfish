...
bool is_ancestor(struct  capability* child,struct  capability* parent) {
    bool _fof_x186;
    genpaddr_t _fof_x187;
    genpaddr_t _fof_x188;
    gensize_t _fof_x189;
    gensize_t _fof_x190;
    struct  capability* child__180;
    struct  capability child__180__181;
    enum objtype child__180__181__184;
    struct  capability* parent__182;
    struct  capability parent__182__183;
    enum objtype parent__182__183__185;
 
    child__180 = child;
    child__180__181 = *child__180;
    parent__182 = parent;
    parent__182__183 = *parent__182;
    child__180__181__184 = child__180__181.type;
    parent__182__183__185 = parent__182__183.type;
    _fof_x186 = is_well_founded(parent__182__183__185,child__180__181__184);
    if ((! _fof_x186)){
        return (0);
    } else {
    }
    _fof_x187 = get_address(parent);
    _fof_x188 = get_address(child);
    _fof_x189 = get_size(parent);
    _fof_x190 = get_size(child);
    if ((child__180__181__184 == parent__182__183__185)){
        return ((((_fof_x187 < _fof_x188) & ((_fof_x187 + _fof_x189) >= (_fof_x188 + _fof_x190))) | ((_fof_x187 <= _fof_x188) & ((_fof_x187 + _fof_x189) > (_fof_x188 + _fof_x190)))));
    } else {
        return (((_fof_x187 <= _fof_x188) & ((_fof_x187 + _fof_x189) >= (_fof_x188 + _fof_x190))));
    }
}
 
bool is_copy(struct  capability* left,struct  capability* right) {
    int8_t _fof_x179;
    struct  capability* left__173;
    struct  capability left__173__174;
    enum objtype left__173__174__177;
    struct  capability* right__175;
    struct  capability right__175__176;
    enum objtype right__175__176__178;
 
    left__173 = left;
    left__173__174 = *left__173;
    right__175 = right;
    right__175__176 = *right__175;
    left__173__174__177 = left__173__174.type;
    right__175__176__178 = right__175__176.type;
    if ((left__173__174__177 != right__175__176__178)){
        return (0);
    } else {
    }
    switch (left__173__174__177) {
        case ObjType_PerfMon: {
            return (1);
            break;
        }
    ...
    _fof_x179 = compare_caps(left,right,0);
    return ((_fof_x179 == 0));
}
...
bool is_revoked_first(struct cte * src_cte,enum objtype src_type) {
    ...
    switch (src_type) {
        case ObjType_DevFrame: {
            _fof_x172 = has_descendants(src_cte);
            if (_fof_x172){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_Frame: {
            _fof_x171 = has_descendants(src_cte);
            if (_fof_x171){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_RAM: {
            _fof_x170 = has_descendants(src_cte);
            if (_fof_x170){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_PhysAddr: {
            _fof_x169 = has_descendants(src_cte);
            if (_fof_x169){
                return (0);
            } else {
                return (1);
